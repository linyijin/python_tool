...
function[] = spinandcutR45_Norm(imgSize,slidwindow,overlapping,angleInterval,Markthreshold,txtpath, postxtpath, imgpath, maskpath,imgsavepath, datapathmask, possamplesavepath)
% 生成相关文件夹
% 生成相关文件夹
...
%              spin45(othername, img, mask, 360 - angle , imgsavepath, datapathmask, instpath, binarypath, clspath, slidwindow, overlapping, Markthreshold, txtpath, possamplesavepath, postxtpath);
        spin45_Norm(othername, img, mask, 360 - angle , imgsavepath, datapathmask, slidwindow, overlapping, Markthreshold, txtpath, possamplesavepath, postxtpath);
